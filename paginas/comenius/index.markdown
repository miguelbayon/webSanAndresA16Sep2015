	    	...
	    	<div class="row padding-top ">
	            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
	                <div class="widget">
						...
						<p>During the next morning we also visited the city enjoying the parade of the Independence Day of the country.</p>
...
<!--		<h2 style="text-align: center">School visit to Dublin (March 2014)</h2>
		...
		<div class="row" style="margin-bottom: 2em">
			...
			<div class="col-md-8">
				...
				<p>A group of students of 3ºESO and 4ºESO have spent five days in Dublin where they have had the opportunity to visit the area and practise the English language.</p>

				<p>During this week, they attended lessons at the International House School and visited the most important sites in the city. They also learnt how the Guinness beer is made and enjoyed the wonderful views of Dublin from the Gravity Bar.</p>

				<p>There was a deep linguistic and cultural immersion because one of the activities consisted of learning how to dance typical Irish dances. It was really funny and challenging.</p>

				<p>The students´accommodation was another important part of the trip, since they had the chance to know real Irish families, sharing their lifestyles.</p>

				<p>Appart from the city itself, they also had a day trip to Glendalough (which is one of the first Christian settlements surrounded by impressive nature), and Powerscourt Gardens.</p>

				<p>A funny story to note, is the seal that one of our students could see in Howth near the lighthouse, while we were having a walk along the seafront.</p>

				<p>We hope we can do this kind of activity again because it is really rewarding both for teachers and kids.</p>

			</div>

			<div class="col-md-4" style="padding: 0em 2em">		
				<img class="img-responsive" src="/imagenes/irelandEurope.jpg">
				</a>	
			</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a href="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2337.JPG" class="image">
					<img class="img-responsive" src="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2337.JPG">
				</a>			
			</div>

			<div class="col-md-3">
				<a href="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2281.JPG" class="image">
					<img class="img-responsive" src="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2281.JPG">
				</a>			
			</div>

			<div class="col-md-3">
				<a href="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2162.JPG" class="image">
					<img class="img-responsive" src="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2162.JPG">
				</a>			
			</div>

			<div class="col-md-3">
				<a href="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2399.JPG" class="image">
					<img class="img-responsive" src="https://googledrive.com/host/0BwMgXZ83HVDld3dSUDU3Q3c2NFk/DSC_2399.JPG">
				</a>			
			</div>			
