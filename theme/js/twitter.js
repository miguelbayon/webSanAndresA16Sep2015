...
var twitterFetcher = function() {
  ...
  var showRts = true;
  var customCallbackFunction = false;
  ...
  function handleTweets(tweets){
    if (customCallbackFunction === null) {
      ...
      html = '<div class="testimonial-carousel text-center">\
                            ...
                            <div class="media">\
                                <img src="demos/client_01.jpg" alt="" class="img-circle img-responsive">\
                            </div><!-- end entry -->\
                            <div class="testimonial-names">\
                                <h3>Filiz OZER</h3>\
                                <a href="#" class="readmore">C0-Founder (JollyThemes)</a>\
...
';
      ...
      $("#owl-testimonial-widget").css({ opacity: 0 });
...
*/
        ...
        var op = '<div class="testimonial-carousel text-center">';
        if (parseLinks) {
          if (printUser) {
        ...
        if (showImages && images[n] !== undefined) {
          op += '<div class="media">' +
              '<img class="img-responsive" src="' + extractImageUrl(images[n]) + '" alt="Image from tweet" />' +
              '</div>';
        }

        op += "</div>";

        op = '<div class="testimonial-carousel text-center"><div class="testimonial-wrap"><p class="lead">"Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero"</p></div><div class="media"><img src="demos/client_01.jpg" alt="" class="img-circle img-responsive"></div><!-- end entry --><div class="testimonial-names"><h3>Filiz OZER</h3><a href="#" class="readmore">C0-Founder (JollyThemes)</a></div><!-- end testimonial-names --></div><!-- end testimonial-carousel -->';
